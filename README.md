...
A curated list of awesome [Camunda Platform 8](https://camunda.com/platform/) projects, mostly driven by the community. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 184,676 | 🐛 230 | 🌐 Go | 📅 2026-09-18.
...
* [Java](https://github.com/camunda/zeebe/tree/main/clients/java) ⭐ 4,278 | 🐛 2,812 | 🌐 Java | 📅 2026-09-18
  * [Spring](https://github.com/camunda-community-hub/spring-zeebe) ⭐ 215 | 🐛 13 | 🌐 Java | 📅 2026-09-17
  * [Micronaut](https://github.com/camunda-community-hub/micronaut-zeebe-client) ⭐ 28 | 🐛 7 | 🌐 Java | 📅 2026-03-20
* [Go](https://github.com/camunda-cloud/zeebe/tree/master/clients/go) ⭐ 4,278 | 🐛 2,812 | 🌐 Java | 📅 2026-09-18
...
* [C#](https://github.com/camunda-community-hub/zeebe-client-csharp) ⭐ 114 | 🐛 40 | 🌐 C# | 📅 2026-09-18
* [WorkIt](https://github.com/VilledeMontreal/workit) ⭐ 62 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-13 - Node.js (TypeScript) client for both Zeebe and Camunda BPM platforms (Not updated for Zeebe 1.0.0)
...
* Python:
  * [Pyzeebe](https://github.com/camunda-community-hub/pyzeebe) ⭐ 101 | 🐛 25 | 🌐 Python | 📅 2026-09-18
...
* [DMN Scala](https://github.com/camunda/dmn-scala/) ⭐ 42 | 🐛 26 | 🌐 Scala | 📅 2026-09-18 - Zeebe job worker using the Scala DMN engine
* [Script](https://github.com/camunda-community-hub/zeebe-script-worker) ⭐ 33 | 🐛 2 | 🌐 Java | 📅 2026-09-18 - Zeebe job worker for evaluating JS, Groovy, Kotlin and FEEL scripts
...
* [Elasticsearch](https://github.com/camunda/zeebe/tree/main/exporters/elasticsearch-exporter) ⭐ 4,278 | 🐛 2,812 | 🌐 Java | 📅 2026-09-18
...
* [ZeeQS](https://github.com/camunda-community-hub/zeeqs) ⭐ 60 | 🐛 14 | 🌐 Kotlin | 📅 2025-06-05 - GraphQL query API for aggregated Zeebe data
...
* [Zeebe Test Container](https://github.com/camunda-community-hub/zeebe-test-container) ⭐ 24 | 🐛 17 | 🌐 Java | 📅 2026-09-15 - [TestContainers](https://testcontainers.org) module to help you write integration tests against configurable Zeebe instances.
...
* [Zeebe Chaos](https://github.com/zeebe-io/zeebe-chaos) ⭐ 23 | 🐛 47 | 🌐 Go | 📅 2026-09-17 - contains everything related to chaos engineering and Zeebe, like chaos experiments, an hypotheses backlog etc.
* [Camunda 8 Benchmark (c8b)](https://github.com/camunda-community-hub/camunda-8-benchmark) ⭐ 22 | 🐛 39 | 🌐 Java | 📅 2026-09-18 - a load generator for Zeebe.
...
* [FEEL REPL](https://camunda.github.io/feel-scala/docs/reference/#feel-repl) - easily try FEEL expressions using the REPL (Read-Eval-Print-Loop) of the [FEEL Scala engine](https://github.com/camunda/feel-scala) ⭐ 136 | 🐛 44 | 🌐 Scala | 📅 2026-09-18.
* [zdb](https://github.com/Zelldon/zdb) ⭐ 34 | 🐛 16 | 🌐 Java | 📅 2026-09-18 - Zeebe debug and inspection tool, allows to inspect the log and internal state of Zeebe.
* [zeebe-worker-java-template](https://github.com/camunda-community-hub/zeebe-worker-java-template) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2023-12-15 - Minimal template for a [Zeebe](https://github.com/camunda-cloud/zeebe) ⭐ 4,278 | 🐛 2,812 | 🌐 Java | 📅 2026-09-18
