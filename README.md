...
A curated list of awesome [Camunda Platform 8](https://camunda.com/platform/) projects, mostly driven by the community. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 185,591 | 🐛 229 | 🌐 Go | 📅 2026-09-25.
...
* [Java](https://github.com/camunda/zeebe/tree/main/clients/java) ⭐ 4,296 | 🐛 2,825 | 🌐 Java | 📅 2026-09-25
...
* [Go](https://github.com/camunda-cloud/zeebe/tree/master/clients/go) ⭐ 4,296 | 🐛 2,825 | 🌐 Java | 📅 2026-09-25
...
* Python:
  * [Pyzeebe](https://github.com/camunda-community-hub/pyzeebe) ⭐ 101 | 🐛 26 | 🌐 Python | 📅 2026-09-25
...
* [Script](https://github.com/camunda-community-hub/zeebe-script-worker) ⭐ 33 | 🐛 2 | 🌐 Java | 📅 2026-09-25 - Zeebe job worker for evaluating JS, Groovy, Kotlin and FEEL scripts
...
* [Elasticsearch](https://github.com/camunda/zeebe/tree/main/exporters/elasticsearch-exporter) ⭐ 4,296 | 🐛 2,825 | 🌐 Java | 📅 2026-09-25
...
* [Zeebe Test Container](https://github.com/camunda-community-hub/zeebe-test-container) ⭐ 24 | 🐛 16 | 🌐 Java | 📅 2026-09-25 - [TestContainers](https://testcontainers.org) module to help you write integration tests against configurable Zeebe instances.
...
* [Zeebe Chaos](https://github.com/zeebe-io/zeebe-chaos) ⭐ 23 | 🐛 48 | 🌐 Go | 📅 2026-09-24 - contains everything related to chaos engineering and Zeebe, like chaos experiments, an hypotheses backlog etc.
* [Camunda 8 Benchmark (c8b)](https://github.com/camunda-community-hub/camunda-8-benchmark) ⭐ 22 | 🐛 39 | 🌐 Java | 📅 2026-09-25 - a load generator for Zeebe.
...
* [FEEL REPL](https://camunda.github.io/feel-scala/docs/reference/#feel-repl) - easily try FEEL expressions using the REPL (Read-Eval-Print-Loop) of the [FEEL Scala engine](https://github.com/camunda/feel-scala) ⭐ 136 | 🐛 46 | 🌐 Scala | 📅 2026-09-25.
* [zdb](https://github.com/Zelldon/zdb) ⭐ 35 | 🐛 17 | 🌐 Java | 📅 2026-09-25 - Zeebe debug and inspection tool, allows to inspect the log and internal state of Zeebe.
* [zeebe-worker-java-template](https://github.com/camunda-community-hub/zeebe-worker-java-template) ⭐ 4 | 🐛 0 | 🌐 Java | 📅 2023-12-15 - Minimal template for a [Zeebe](https://github.com/camunda-cloud/zeebe) ⭐ 4,296 | 🐛 2,825 | 🌐 Java | 📅 2026-09-25
